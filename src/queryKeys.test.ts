...
describe('ssoQueryKeys', () => {
    ...
    describe('admin.roles', () => {
        ...
        it('should generate admin role keys with org slug', () => {
            expect(ssoQueryKeys.admin.roles.all(orgSlug)).toEqual([
                'sso',
                'admin',
                'my-org',
                'roles',
            ]);
            expect(ssoQueryKeys.admin.roles.list(orgSlug)).toEqual([
                'sso',
                'admin',
                'my-org',
                'roles',
        ...
        it('should generate admin role detail key', () => {
            expect(ssoQueryKeys.admin.roles.detail(orgSlug, 456)).toEqual([
                'sso',
                'admin',
                'my-org',
                'roles',
        ...
        it('should generate admin role permissions key', () => {
            expect(ssoQueryKeys.admin.roles.permissions(orgSlug, 789)).toEqual([
                'sso',
                'admin',
                'my-org',
                'roles',
    ...
    describe('admin.permissions', () => {
        ...
        it('should generate admin permission keys', () => {
            expect(ssoQueryKeys.admin.permissions.all(orgSlug)).toEqual([
                'sso',
                'admin',
                'test-org',
                'permissions',
            ]);
            expect(ssoQueryKeys.admin.permissions.matrix(orgSlug)).toEqual([
                'sso',
                'admin',
                'test-org',
                'permissions',
        ...
        it('should generate admin permission list with params', () => {
            ...
            expect(ssoQueryKeys.admin.permissions.list(orgSlug, params)).toEqual([
                'sso',
                'admin',
                'test-org',
                'permissions',
    ...
    describe('admin.teams', () => {
        const orgSlug = 'team-org';

        it('should generate admin team keys', () => {
            expect(ssoQueryKeys.admin.teams.all(orgSlug)).toEqual([
                'sso',
                'admin',
                'team-org',
                'teams',
            ]);
            expect(ssoQueryKeys.admin.teams.list(orgSlug)).toEqual([
                'sso',
                'admin',
                'team-org',
                'teams',
            ...
            expect(ssoQueryKeys.admin.teams.orphaned(orgSlug)).toEqual([
                'sso',
                'admin',
                'team-org',
                'teams',
        ...
        it('should generate team permission key', () => {
            expect(ssoQueryKeys.admin.teams.permissions(orgSlug, 999)).toEqual([
                'sso',
                'admin',
                'team-org',
                'teams',
